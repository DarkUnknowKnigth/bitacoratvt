                    ...
                    <form wire:submit="{{ $failure_id ? 'update' : 'save' }}" method="post" class="w-full">
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" wire:model="description" rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
